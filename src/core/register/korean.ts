...
export const registerKorean = (parsers: ParsersBuilder) => {
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_UI_String", Korean_tb_UI_String);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Option_String", Korean_tb_Option_String);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_item_model", Korean_tb_item_model);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_item", Korean_tb_item);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Appearance", Korean_tb_Appearance);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Create_Cloth", Korean_tb_Create_Cloth);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_CreateOption", Korean_tb_CreateOption);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_Info", Korean_tb_Customize_Info);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_Eyes", Korean_tb_Customize_Eyes);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_Hair", Korean_tb_Customize_Hair);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_Skin", Korean_tb_Customize_Skin);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_View_Ani", Korean_tb_Customize_View_Ani);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_View_Ani", Korean_tb_Customize_View_Ani);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_View_Costume", Korean_tb_Customize_View_Costume);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_View_Sound", Korean_tb_Customize_View_Sound);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Customize_View_Weapon", Korean_tb_Customize_View_Weapon);
  parsers.add(GameToken.kr, GameVersion.kr_1_7_50_11, "tb_Event_Condition", Korean_tb_Event_Condition);
